...
const baseEducationSchema = createInsertSchema(education, {
...
export const updateEducationSchema = baseEducationSchema.partial();


export const educationValidation = baseEducationSchema.refine(
